          ...
          child: SafeArea(
            child: Column(
              children: [
                ...
                if (progress.valueOrNull?.isPremium != true &&
                    ads.homeBannerReady &&
                    ads.homeBanner != null)
                  Container(
          ...
          Row(
            children: [
              ...
              IconButton(
                ...
                icon: const Icon(Icons.bar_chart_rounded, color: Colors.white, size: 23),
                onPressed: () {
                  sound.click();
  ...
  Widget build(BuildContext context) => ListView(
        ...
        children: [
          ...
          ...units.asMap().entries.map(
            (e) => _UnitCard(unit: e.value, unitIndex: e.key)
                .animate()
                .fadeIn(delay: Duration(milliseconds: 70 * e.key))
  ...
  Widget build(BuildContext context, WidgetRef ref) => GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: WaqtiColors.accent.withValues(alpha: .4),
                blurRadius: 14,
...
class _UnitCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: color.withValues(alpha: .1), blurRadius: 10, offset: const Offset(0, 3)),
        ],
      ),
      child: Column(
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        unit.subtitle,
                        style: TextStyle(fontFamily: 'Cairo', fontSize: WaqtiSize.xs(context), color: WaqtiColors.textLight),
                      ),
  ...
  Widget _badge(String text, Color color) => Container(
        ...
        child: Text(
          text,
          style: const TextStyle(fontFamily: 'Cairo', fontSize: 10, fontWeight: FontWeight.w700, color: Colors.white),
        ),
      );
}
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return InkWell(
      onTap: !unlocked
          ...
          : () {
              ref.read(soundServiceProvider).click();
              context.push(Routes.lesson, extra: LessonRouteArgs(unit: unit, lesson: lesson));
            },
      child: Opacity(
          ...
          child: Row(
            children: [
              Container(
                ...
                height: 32,
                decoration: BoxDecoration(
                  color: done ? color : color.withValues(alpha: .12),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      lesson.title,
                      style: TextStyle(fontFamily: 'Cairo', fontSize: WaqtiSize.sm(context), fontWeight: FontWeight.w600, color: WaqtiColors.textDark),
                    ),
                    Text(
                      lesson.subtitle,
                      style: TextStyle(fontFamily: 'Cairo', fontSize: WaqtiSize.xs(context), color: WaqtiColors.textLight),
