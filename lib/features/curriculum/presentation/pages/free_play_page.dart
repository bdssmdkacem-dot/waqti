    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('🕐 العب بالساعة', style: TextStyle(fontFamily: GoogleFonts.cairo().fontFamily, fontWeight: FontWeight.w700)),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(children: [
              ...
              Container(
                ...
                child: Text(_arabicTime, style: const TextStyle(fontFamily: GoogleFonts.cairo().fontFamily, fontSize: 16, fontWeight: FontWeight.w600, color: Color(0xFF1B5E20))),
              ),
