                ...
                builder: (_, __) => Column(children: [
                  ...
                  if (!sound.isMuted) ...[
                    ...
                    Text('مستوى الصوت: ${(sound.volume*100).round()}%',
                      ...
                      style: const TextStyle(fontFamily: 'Cairo', fontSize: 12, color: WaqtiColors.textLight)),
                  ],
                ]),
              ),
            ])),
            ...
            _Card(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: const Text('إعادة تعيين كل التقدم', style: TextStyle(fontFamily: 'Cairo', color: Colors.red)),
...
class _SectionHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(children: [
    ...
    Text(label, style: TextStyle(fontFamily: 'Cairo', fontSize: 17, fontWeight: FontWeight.w700,
...
class _StatPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Expanded(child: Container(
    ...
    child: Column(children: [
      ...
      Text(value, style: const TextStyle(fontFamily: 'Cairo', fontSize: 18, fontWeight: FontWeight.w800, color: WaqtiColors.primary)),
      Text(label, style: const TextStyle(fontFamily: 'Cairo', fontSize: 10, color: WaqtiColors.textLight)),
    ]),
  ));
}
